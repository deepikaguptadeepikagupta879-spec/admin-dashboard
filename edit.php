...
<title>Edit Laptop | <?= SITE_NAME ?></title>
...
name="processor"
class="form-control"
value="<?= htmlspecialchars($product["processor"]) ?>">
...
name="graphics"
class="form-control"
value="<?= htmlspecialchars($product["graphics"]) ?>">
...
name="display_size"
class="form-control"
value="<?= htmlspecialchars($product["display_size"]) ?>">
...
class="form-control"
value="<?= htmlspecialchars($product["operating_system"]) ?>">
...
name="battery"
class="form-control"
value="<?= htmlspecialchars($product["battery"]) ?>">
...
<img
src="<?= $product["image"] ?>"
style="width:180px;height:180px;object-fit:contain;margin-bottom:15px;">
